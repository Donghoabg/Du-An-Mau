...
<div class="vien">
    <header>
        ...
        echo "Xin chào ";
        ?>
        <a href="?page=register" class="btn btn-outline-primary">Đăng ký</a>
    ...
    <div class="container">
        <nav>
            ...
            <div class="searchs">
                <form method="get" action="" onsubmit="<?php if (!isset($_SESSION['id'])) echo 'event.preventDefault(); requireLogin();'; ?>">
...
<div class="slider-wrapper">
    ...
    <div class="gallery" id="gallery">
        <?php foreach ($productss as $product): ?>
            <div class="box3">
                <a href="<?= isset($_SESSION['id']) ? '?page=chitiet&id=' . $product['id'] : 'javascript:void(0);' ?>" 
                 <?php if (!isset($_SESSION['id'])) echo 'onclick="requireLogin()"'; ?>>
        ...
        <?php
            ...
            foreach ($products as $img) {
                ...
                <div class="newproduct">
                    ...
                    <a href="<?= isset($_SESSION['id']) ? '?page=chitiet&id=' . $img['id'] : 'javascript:void(0);' ?>" 
                    <?php if (!isset($_SESSION['id'])) echo 'onclick="requireLogin()"'; ?>>
                        ...
                        <div class="boxdathang">
                            ...
                            <?php else: ?>
                                <a href="javascript:void(0);" onclick="requireLogin()">Thêm Giỏ Hàng</a>
                            <?php endif; ?>
                        </div>
    ...
    ?>
    <script>
        function requireLogin(message = "Vui lòng đăng nhập để sử dụng chức năng này.") {
        alert(message);
